...
public class Transaction {
    ...
    public static Transaction debit(
        ...
        return new Transaction(account, counterparty, TransactionType.DEBIT, status, amount, balance, null, failureReason, null);
    }
    ...
    public static Transaction credit(
        ...
        return new Transaction(account, counterparty, TransactionType.CREDIT, status, amount, balance, null, failureReason, null);
    }
